...
const (
	ExecutorService_Execute_FullMethodName = "/code_executor.ExecutorService/Execute"
)
...
//
// ExecutorService handles code execution.
...
var ExecutorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "code_executor.ExecutorService",
